...
var JiraApi = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(JiraApi, [{
    ...
    key: "editWebhook",
    value: function editWebhook(webhookID,webhook) {
      return this.doRequest(this.makeRequestHeader(this.makeWebhookUri({
        pathname: "/webhook/".concat(webhookID)
      }), {
        method: 'PUT',
    ...
    /** getSubtask
     * [Jira Doc](https://docs.atlassian.com/software/jira/docs/api/REST/7.6.1/#api/2/issue/{issueIdOrKey}/subtask-canMoveSubTask)
     * @name getSubtask
     * @function
     * @param {string} issueId - issue id
     */
    ...
    key: "getSubtask",
    value: function getSubtask(issueId) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/issue/".concat(issueId, "/subtask")
      }), {
        method: 'GET',
      }));
    }
     ...
     */
      ...
      key: "getIssueEditMetadata",
      value: function getIssueEditMetadata(issueIdOrKey) {
        var optional = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        return this.doRequest(this.makeRequestHeader(this.makeUri({
          pathname: "/issue/".concat(issueIdOrKey,'/editmeta'),
          query: optional
        })));
      }
  }, {
